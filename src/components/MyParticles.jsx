...
// //import MyParticlesComponent from './components/MyPerticles';
...
function MyParticles({ transformedImages, imageNames }) {
	console.log('Particles-transformedImages:', transformedImages);
